...
class Checker:
    ...
    # TODO -> Insert all info about admin/tech/owner in table 'Domains'. Later analyse the need to change    
    ...
    def get_name_servers(self, domain_obj):
        if 'name_servers' in domain_obj:
            return domain_obj['name_servers']
        elif 'name_server' in domain_obj:
            return domain_obj['name_server']
        else:
            return None
